(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('iconv-lite')) :
  typeof define === 'function' && define.amd ? define(['exports', 'iconv-lite'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['ts-shapefile'] = {}, global.iconvLite));
}(this, (function (exports, iconvLite) { 'use strict';

  class ShapeFeature {
      constructor(geom, attributes, fieldInfo) {
          this.geom = geom;
  ...
  ***************************************************************************** */
  ...
  var CoordType;
  (function (CoordType) {
      CoordType[CoordType["NULL"] = 0] = "NULL";
      CoordType[CoordType["XY"] = 2] = "XY";
      CoordType[CoordType["XYM"] = 3] = "XYM";
      CoordType[CoordType["XYZM"] = 4] = "XYZM";
  })(CoordType || (CoordType = {}));
  ...
  class CoordXY extends CoordinateBase {
      constructor(x, y) {
          super();
          this.hasZ = false;
          this.hasM = false;
  ...
  class CoordXYM extends CoordinateBase {
      constructor(x, y, m) {
          super();
          this.hasZ = false;
          this.hasM = true;
  ...
  class CoordXYZM extends CoordinateBase {
      constructor(x, y, z, m) {
          super();
          this.hasZ = true;
          this.hasM = true;
  ...
  class GeomUtil {
      ...
      static hasZ(shapeType) {
          const type = GeomUtil.pointType(shapeType);
          return type === CoordType.XYZM;
      }
      static hasM(shapeType) {
          const type = GeomUtil.pointType(shapeType);
          return type === CoordType.XYZM || type === CoordType.XYM;
      }
      static shapeTypeStr(shapeType) {
          if (shapeType in exports.ShapeType) {
              return exports.ShapeType[shapeType];
          }
          return 'Unknown';
      }
  }
  class ShpGeometryBase {
      constructor(type) {
          this.type = type;
  ...
  class ShpPoint extends ShpGeometryBase {
  ...
  class ShpMultiPoint extends ShpGeometryBase {
      constructor() {
          super(...arguments);
          this.points = [];
      }
  ...
  class ShpPolyLine extends ShpGeometryBase {
  ...
  class LinerarRing extends LineString {
      area() {
  ...
  class ShpPolygon extends ShpGeometryBase {
      constructor() {
          super(...arguments);
          this.parts = [];
      }
  ...
  class ShpNullGeom extends ShpGeometryBase {
      toGeoJson() {
  ...
  class MemoryStream {
      ...
      readInt32Array(count, littleEndian) {
      ...
      readDoubleArray(count, littleEndian) {
  ...
  class ShapeReader {
      ...
      static fromFile(shp, shx) {
          return __awaiter(this, void 0, void 0, function* () {
              ...
              let shxBytes;
              try {
                  shpBytes = yield shp.arrayBuffer();
              }
              catch (err) {
                  throw new Error(`Failed to open .shp: ${err.message}`);
              }
              try {
                  shxBytes = yield shx.arrayBuffer();
              }
              catch (err) {
                  throw new Error(`Failed to open .shp: ${err.message}`);
              }
      ...
      static fromArrayBuffer(shpBytes, shxBytes) {
          return __awaiter(this, void 0, void 0, function* () {
      ...
      _readGeomHeader() {
          ...
          const type = this._shpStream.readInt32(true);
          return {
              length: len,
              recordNum: recNum,
              type: type
      ...
      readGeom(geomIndex) {
          ...
          if (this._shpHeader.type !== recHead.type) {
              if (recHead.type === exports.ShapeType.Null) {
                  return new ShpNullGeom(recHead.type);
              }
              throw new Error(`Unexpected shape type ${GeomUtil.shapeTypeStr(recHead.type)}(${recHead.type}), expected ${GeomUtil.shapeTypeStr(this._shpHeader.type)}`);
          }
          switch (recHead.type) {
              case exports.ShapeType.Point:
              case exports.ShapeType.PointZ:
              case exports.ShapeType.PointM:
                  return this._readPoint(recHead);
              case exports.ShapeType.MultiPoint:
              case exports.ShapeType.MultiPointZ:
              case exports.ShapeType.MultiPointM:
                  return this._readMultiPoint(recHead);
              case exports.ShapeType.PolyLine:
              case exports.ShapeType.PolyLineZ:
              case exports.ShapeType.PolyLineM:
                  return this._readPolyLine(recHead);
              case exports.ShapeType.Polygon:
              case exports.ShapeType.PolygonZ:
              case exports.ShapeType.PolygonM:
      ...
      _readPoint(header) {
          ...
          return new ShpPoint(header.type, coord);
      }
      _readMultiPoint(header) {
          ...
          const geom = new ShpMultiPoint(header.type);
      ...
      _readPolyLine(header) {
          const parts = this._readParts(() => new LineString());
          return new ShpPolyLine(header.type, parts);
      }
      _readPolygon(header) {
          const rings = this._readParts(() => new LinerarRing());
          const poly = new ShpPolygon(header.type);
  ...
  */
  ...
  class IconvDecoder {
      ...
      decode(str) {
          return iconvLite.decode(str, this.encoding);
      }
  }
  class DbfDecoderFactory {
      static fromCpgString(cpg) {
          if (!cpg) {
      ...
      static fromDbfLangCode(code) {
          if (code === 0) {
              // Default = 1252
              return new IconvDecoder('cp1252');
          }
          if (code in CpLUT) {
              const cpId = CpLUT[code][0];
  ...
  class DbfReader {
      constructor(dbf, decoder) {
          this._fields = [];
          this._recordStartOffset = 0;
          this._recordSize = 0;
      ...
      get encoding() {
          var _a, _b;
          return (_b = (_a = this._decoder) === null || _a === void 0 ? void 0 : _a.encoding) !== null && _b !== void 0 ? _b : '';
      }
      static fromFile(file, cpgFile) {
          return __awaiter(this, void 0, void 0, function* () {
              if (file == null) {
              ...
              try {
                  ...
                  let cpgBuf;
                  if (cpgFile) {
                      cpgBuf = yield cpgFile.arrayBuffer();
                  }
      ...
      static fromArrayBuffer(buffer, cpgBuf) {
          return __awaiter(this, void 0, void 0, function* () {
              try {
                  let decoder;
                  if (cpgBuf) {
                      const cpgDecoder = new TextDecoder();
                      const cpgStr = yield cpgDecoder.decode(cpgBuf);
      ...
      _readHeader() {
          ...
          while (true) {
              ...
              const fieldType = String.fromCharCode(fieldTypeCode);
              s.seek(recordIdx + 16);
      ...
      _readCharValue(field) {
          const chars = new Uint8Array(field.fieldLen);
  ...
  DbfReader._regExDate = /^(\d\d\d\d)(\d\d)(\d\d)$/;

  class ShapeFeatureReader {
      constructor(shapeFile, dbfReader) {
          if (shapeFile.recordCount !== (dbfReader === null || dbfReader === void 0 ? void 0 : dbfReader.recordCount)) {
              throw new Error(`Record count mismatch: SHP-file has ${shapeFile.recordCount} records, DBF has ${dbfReader === null || dbfReader === void 0 ? void 0 : dbfReader.recordCount}`);
          }
      ...
      static fromArrayBuffers(shp, shx, dbf, cpg) {
          return __awaiter(this, void 0, void 0, function* () {
              if (shp == null) {
              ...
              const shapeReader = yield ShapeReader.fromArrayBuffer(shp, shx);
              let dbfReader;
              if (dbf != null) {
                  dbfReader = yield DbfReader.fromArrayBuffer(dbf, cpg);
              }
              return new ShapeFeatureReader(shapeReader, dbfReader);
          });
      }
      static fromFiles(shp, shx, dbf, cpg) {
          return __awaiter(this, void 0, void 0, function* () {
              if (shp == null) {
                  throw new Error('No .shp file provided');
              }
              ...
              const shapeReader = yield ShapeReader.fromFile(shp, shx);
              let dbfReader;
              if (dbf != null) {
                  dbfReader = yield DbfReader.fromFile(dbf, cpg);
              }
              return new ShapeFeatureReader(shapeReader, dbfReader);
          });
      }
      readFeature(index) {
          ...
          return new ShapeFeature(geom, attrs, (_a = this._dbfReader) === null || _a === void 0 ? void 0 : _a.fields);
      }
      readFeatureCollection() {
          var _a;
          const collection = new ShapeFeatureCollection((_a = this._dbfReader) === null || _a === void 0 ? void 0 : _a.fields);
  ...
  exports.LinerarRing = LinerarRing;
  exports.ShapeFeature = ShapeFeature;
  exports.ShapeFeatureCollection = ShapeFeatureCollection;
  exports.ShapeFeatureReader = ShapeFeatureReader;
  exports.ShapeReader = ShapeReader;
  exports.ShpGeometryBase = ShpGeometryBase;
  exports.ShpPoint = ShpPoint;
  exports.ShpPolyLine = ShpPolyLine;
  exports.ShpPolygon = ShpPolygon;
